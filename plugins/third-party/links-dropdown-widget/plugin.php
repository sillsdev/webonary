...
class Links_Dropdown_Widget extends WP_Widget
{
	...
	public function form($instance): void
	{
		...
		$default_field_id = $this->get_field_id('default_option');
		$default_field_name = $this->get_field_name('default_option');

		echo <<<HTML
<p><label for="$title_field_id">$title_label</label> <input class="widefat" id="$title_field_id" name="$title_field_name" type="text" value="$title"></p>
<p><label for="$default_field_id"><?php _e('Default Option:'); ?></label> <input class="widefat" id="$default_field_id" name="$default_field_name" type="text" value="$default_option"></p>
HTML;
	}
...
add_action('widgets_init', function () {
	register_widget('Links_Dropdown_Widget');
});
