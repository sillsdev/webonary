...
//		echo "This is the field settings section";
		...
		foreach ( self::$form_options['fields'] as $key => $field ) {
			...
			<fieldset class="fscf_field" id="field-<?php echo $nextkey; ?>">
			...
			<input name="<?php echo $field_opt_name.'[standard]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_standard'; ?>" type="hidden"
				   value="<?php echo esc_attr($field['standard']);  ?>" />
			<input name="<?php echo $field_opt_name.'[delete]' ?>" id="delete-<?php echo $nextkey; ?>" type="hidden"
				   value="false" />
			<?php
            // special notices

			// new field added message
			if ( !empty(self::$new_field_added) && $fields_count == $nextkey ) {
				// A new field was added, show a message
				echo '<div class="fsc-notice">' . self::$new_field_added . '</div>' . "\n";
                self::$new_field_key = $nextkey;
			}
          ...
          if ( FSCF_EMAIL_FIELD == $field['standard'] && 'true' == self::$form_options['double_email'] && $field['default'] != '' ) {
		   ...
		   &nbsp;&nbsp;&nbsp;<input name="<?php echo $field_opt_name.'[disable]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_disable' ?>" type="checkbox"
			   <?php if( $field['disable'] == 'true' ) echo 'checked="checked"'; ?> value="true" />
		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_disable' ?>"><?php _e('Disable field', 'si-contact-form'); ?></label>

			&nbsp;&nbsp;&nbsp;<input name="<?php echo $field_opt_name.'[follow]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_follow' ?>" type="checkbox"
			   <?php if( $field['follow'] == 'true' ) echo 'checked="checked"'; ?> value="true" />
			<label for="<?php echo 'fs_contact_field'. $nextkey .'_follow' ?>"><?php _e('Follow previous field', 'si-contact-form'); ?></label><br />

		   <strong><?php echo __('Field modifiers', 'si-contact-form'); ?>:</strong>&nbsp;&nbsp;
		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_default' ?>"><?php echo __('Default', 'si-contact-form'); ?>:</label>
		   <input name="<?php echo $field_opt_name.'[default]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_default' ?>" type="text"
				  value="<?php echo esc_attr($field['default']);  ?>" size="45" />

           &nbsp;&nbsp;&nbsp;<input name="<?php echo $field_opt_name.'[hide_label]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_hide_label' ?>" type="checkbox"
			   <?php if( $field['hide_label'] == 'true' ) echo 'checked="checked"'; ?> value="true" />
			<label for="<?php echo 'fs_contact_field'. $nextkey .'_hide_label' ?>"><?php _e('Hide label', 'si-contact-form'); ?></label>

           &nbsp;&nbsp;&nbsp;<input name="<?php echo $field_opt_name.'[placeholder]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_placeholder' ?>" type="checkbox"
			   <?php if( $field['placeholder'] == 'true' ) echo 'checked="checked"'; ?> value="true" />
			<label for="<?php echo 'fs_contact_field'. $nextkey .'_placeholder' ?>"><?php _e('Default as placeholder', 'si-contact-form'); ?></label>


		   <div class="fscf-clear"></div>
			<div class="fscf_left">
		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_options' ?>"><?php echo __('Select options', 'si-contact-form');
		   if ( in_array( $field['type'], $select_type_fields ) ) echo ' (Required)'; ?>:</label><br />
		   <textarea rows="6" cols="40" name="<?php echo $field_opt_name.'[options]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_options' ?>"><?php echo esc_textarea( trim($field['options']) ); ?></textarea></div>
		   &nbsp;&nbsp;&nbsp;<input name="<?php echo $field_opt_name.'[inline]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_inline' ?>" type="checkbox"
			   <?php if( $field['inline'] == 'true' ) echo 'checked="checked"'; ?> value="true" />
		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_inline' ?>"><?php _e('Inline', 'si-contact-form'); ?></label>&nbsp;&nbsp;&nbsp;
		   ...
		   <br /><label for="<?php echo 'fs_contact_field'. $nextkey .'_regex' ?>"><?php echo __('Validation regex', 'si-contact-form'); ?>:</label>
		   <input name="<?php echo $field_opt_name.'[regex]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_regex' ?>" type="text"
				  value="<?php echo esc_attr($field['regex']);  ?>" size="20" /><br />

		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_regex_error' ?>"><?php echo __('Regex fail message', 'si-contact-form'); ?>:</label>
		   <input name="<?php echo $field_opt_name.'[regex_error]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_regex_error' ?>" type="text"
				  value="<?php echo esc_attr($field['regex_error']);  ?>" size="35" /><br />

		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_label_css' ?>"><?php echo __('Label CSS', 'si-contact-form'); ?>:</label>
		   <input name="<?php echo $field_opt_name.'[label_css]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_label_css' ?>" type="text"
				  value="<?php echo esc_attr($field['label_css']);  ?>" size="53" />

		   <br /><label for="<?php echo 'fs_contact_field'. $nextkey .'_input_css' ?>"><?php echo __('Input CSS', 'si-contact-form'); ?>:</label>
		   <input name="<?php echo $field_opt_name.'[input_css]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_input_css' ?>" type="text"
		   ...
		   <div class="clear"></div>
		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_notes' ?>"><?php _e('HTML before form field:', 'si-contact-form'); ?></label><br />
		   <textarea rows="2" cols="40" name="<?php echo $field_opt_name.'[notes]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_notes' ?>"><?php echo esc_textarea($field['notes']);  ?></textarea><br />

		   <label for="<?php echo 'fs_contact_field'. $nextkey .'_notes_after' ?>"><?php _e('HTML after form field:', 'si-contact-form'); ?></label><br />
		   <textarea rows="2" cols="40" name="<?php echo $field_opt_name.'[notes_after]' ?>" id="<?php echo 'fs_contact_field'. $nextkey .'_notes_after' ?>"><?php echo esc_textarea($field['notes_after']);  ?></textarea><br />

       <p class="submit">
		<input id="submit2" class="button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'si-contact-form'); ?>" onclick="document.pressed=this.value" name="submit" />
        <?php if ( '0' == $field['standard'] && empty(self::$new_field_added)  ) { ?>
				<input type="button" class="button-primary" name="<?php echo 'delte field-'.$key; ?>"
				   value="<?php esc_attr_e('Delete Field', 'si-contact-form'); ?>" onclick="fscf_delete_field('<?php echo $nextkey; ?>')" />
		<?php }
        echo '</p>';
