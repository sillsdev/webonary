	...
	function widget( $args, $instance ) {
		...
		?>
			&nbsp;<a href="" id=popuppage1  <?php if(qtrans_getLanguage() == "ii") {?>class="nuosu"<?php }?> onclick="window.open(
				'wp-content/plugins/yi/include/idx_chart.html','popuppage1','width=990,height=610,top=50,left=200,scrollbars=yes');
			...
			<a href="" id=popuppage2  <?php if(qtrans_getLanguage() == "ii") {?>class="nuosu"<?php }?> onClick="window.open('\
				wp-content/plugins/yi/include/idx_radical.html','popuppage2','width=470,height=880,top=50,left=200,scrollbars=yes');
