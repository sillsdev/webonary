						...
						<table class="form-table">
							...
							<tr class="form-required">
								...
								<?php if( is_subdomain_install() ) { ?>
									<input name="blog[domain]" type="text" title="<?php _e( 'Subdomain', $this->_domain ); ?>" class="regular-text"/>.<?php echo "webonary.org";?>
								<?php } else {
									echo "webonary.org" . $current_site->path ?><input name="blog[domain]" type="text" title="<?php _e( 'Domain', $this->_domain ); ?>" class="regular-text"/>
								<?php } ?>
								</td>
							</tr>
