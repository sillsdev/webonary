 ...
 $sql = "SELECT blog_id, link_url, DATE_FORMAT(link_updated, '%Y-%m-%d') AS link_updated
	...
	if (0 < count ( $blogs )) :
		...
		foreach ( $blogs as $blog ) :
			...
			?>
			<?php echo date("Y-m-d", strtotime($recordUpdated)); ?>;<?php echo $site_title; ?>;<?php echo $blog ['link_url']; ?>;<?php echo $ethnologue_code; ?>;<?php echo $entriesTotal; ?>;<?php echo date("Y-m-d", strtotime($lastEditDate)); echo "<br>";?>
<?php
		$i++;
		//}
	endforeach;
