...
function themezee_enqueue_scripts() {
  ...
  wp_register_style('repsonive_menu_stylesheet', get_stylesheet_directory_uri() . '/includes/css/responsive-menu.css?v=1');
...
function getPublishedSitesCount($atts)
{
	global $wpdb;
...
function webonary_home_enqueue_jquery() {
