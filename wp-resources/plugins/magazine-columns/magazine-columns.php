 ...
 */
function add_magazine_columns(string $content): string
{
 ...
 *
 */
function add_magazine_columns_css(): void
{
	global $post;
	...
	if (!stristr($post->post_content, '<!--column-->'))
		return;

	echo <<<HTML
<!-- Magazine Columns CSS -->
<style>
#magazine-columns{margin:0 -20px 1em;overflow:hidden}
.column {float:left;box-sizing:border-box;padding:0 20px}
.column.c2{width:50%}
 ...
 */
function add_magazine_columns_quicktags(): void
{
