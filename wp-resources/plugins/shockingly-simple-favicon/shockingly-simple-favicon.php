...
function favi_geturl() {
	$opt = get_option('favi_options');
	$icon = $opt['url'] ?? get_option('siteurl') . '/wp-content/plugins/shockingly-simple-favicon/default/favicon.ico';;
	return $icon;
}
...
function favi_menu() {
	global $favi_dom;
	add_options_page(__('Shockingly Simple Favicon Options', $favi_dom), __('S. Simple Favicon', $favi_dom), 'edit_theme_options', __FILE__, 'favi_options');
}
