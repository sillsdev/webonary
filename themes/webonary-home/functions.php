...
function webonary_home_enqueue_jquery(): void
{
	...
	wp_register_style(
		'datatables-style',
		'https://cdn.datatables.net/v/dt/dt-2.3.7/sl-3.1.3/datatables.min.css'
	);
	wp_enqueue_style('datatables-style');

	wp_register_script(
		'datatables-script',
		'https://cdn.datatables.net/v/dt/dt-2.3.7/sl-3.1.3/datatables.min.js',
		[],
		false,
		true
	);
	...
	wp_enqueue_script('datatables-webonary-script');
}
