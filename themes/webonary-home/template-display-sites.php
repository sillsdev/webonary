...
<script type="text/javascript">
    ...
    function setTableHeight() {
        ...
        let container = $('#all-sites-table').closest('.dt-scroll');
	...
	addEventListener('load', () => {
	    ...
	    new DataTable('#all-sites-table', {
	        ...
	        order: [[0, 'asc']],
	        layout: {
				topStart: $('<button type="button" onclick="window.open(\'?excel\', \'_blank\');" class="spbutton">Excel</button>'),
				topEnd: {
					search: {
						placeholder: 'Search'
					}
