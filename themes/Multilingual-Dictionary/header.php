...
<title><?php _e('Nuosu Yi-Chinese-English Glossary (online dictionary)', 'dictrans'); //bloginfo('name'); ?> <?php if ( is_single() ) { ?> &raquo; Blog Archive <?php } ?> <?php wp_title(); ?></title>

<meta name="generator" content="WordPress <?php bloginfo('version'); ?>" /> <!-- leave this for stats -->
<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory') ?>/reset-fonts-grids-tabs.css" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory') ?>/wp-page-numbers.css" />
<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>" type="text/css" media="screen" />
<?php /* <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory') ?>/dictionary.css" type="text/css" /> */ ?>
...
{
  	echo "<br>Please install the plugin qTranslate.";
  	exit;
}
*/
?>
